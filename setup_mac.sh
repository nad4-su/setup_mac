...
echo "        ⌃⌥F : 전체 화면      ⌃⌥C : 가운데"
echo ""
echo "  7️⃣  Docker Desktop 확인:"
echo "     open -a Docker    # → Docker Desktop 최초 실행"
echo "     docker --version  # → Docker CLI 버전 확인"
echo "     docker compose version"
echo "     ※ 최초 실행 시 권한 승인/로그인이 필요할 수 있습니다."
echo ""
echo "  8️⃣  Claude Code 확인:"
